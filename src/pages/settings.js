...
const MENU_PAGE_OPTIONS = [
  ...
  { key: 'doc_deadline',     label: '공문 기한 추적' },
  { key: 'neis_helper',      label: '나이스 도우미' },
  { key: 'class_budget',     label: '학급운영비 관리' },
  { key: 'newsletter',       label: '가정통신문 AI 작성' },
  { key: 'efficiency',       label: '업무 효율 분석' },
...
const DEFAULT_MENU_GROUPS = [
  ...
  { key: 'admin',      label: '업무',     items: ['official_document', 'doc_deadline', 'neis_helper', 'class_budget', 'newsletter', 'efficiency'] },
