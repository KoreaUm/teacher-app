(function () {
  ...
  async function render(container) {
    ...
    container.innerHTML = [
      ...
      '          <h3>입력 항목</h3>',
      '          <span>제목, 본문, 시행일자만 있어도 초안이 생성됩니다.</span>',
      '        </div>',
      '        <label>문서 유형<select id="od-document-type">' + options + '</select></label>',
      '        <label>수신자 <small>선택, 여러 명이면 한 줄에 한 명씩 입력</small><textarea id="od-recipients" rows="3" placeholder="예: 각급 학교장&#10;예: 청주시교육지원청교육장"></textarea></label>',
      ...
      '        </div>',
      '        <div class="official-doc-two">',
      '          <label>발신 기관 <small>선택</small><input id="od-sender-org" placeholder="예: ○○고등학교"></label>',
      '          <label>발신 부서 <small>선택</small><input id="od-sender-dept" placeholder="예: 교무기획부"></label>',
      '        </div>',
      '        <div class="official-doc-two">',
      '          <label>담당자 <small>선택</small><input id="od-sender-name" placeholder="예: 홍길동"></label>',
      '          <label>발신명의 <small>선택</small><input id="od-sender-title" placeholder="예: ○○고등학교장"></label>',
      '        </div>',
